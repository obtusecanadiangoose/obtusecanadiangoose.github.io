...
sidebar:
  ...
  - text: "Send co-ordinates to a raspberry pi acting as a HID mouse"
  - text: "Move mouse and click on enemy head"
  
  - title: "Experience Gained:"
  - text: "OpenCV - masking, bounding boxes"
  - text: "UDP sockets"
  - text: "Raspberrypi0 HID emulation"
---
Is it perfect? No.
...
<figure style="width: 248px" class="align-center">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-raw.png" alt="">
</figure> 
...
<figure style="width: 248px" class="align-center">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-masked.png" alt="">
</figure> 

3. While this is just basic contouring to find all connected edges, it is helped by thresholding and masking.

<figure style="width: 248px" class="align-center">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-contoured.png" alt="">
</figure> 
...
<figure style="width: 248px" class="align-center">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-head.png" alt="">
</figure> 

All 4 components in action:

<figure style="width: 130px" class="align-left">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-raw.gif" alt="">
  <figcaption>1. Raw Input</figcaption>
</figure> 
<figure style="width: 130px" class="align-left">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-masked.gif" alt="">
  <figcaption>2. Masked</figcaption>
</figure> 
<figure style="width: 130px" class="align-left">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-contoured.gif" alt="">
  <figcaption>3. Contours</figcaption>
</figure> 
<figure style="width: 130px" class="align-left">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/VA-head.gif" alt="">
